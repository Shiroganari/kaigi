<section class="registration">
    ...
    <form class="form" method="post" action="auth/registration">
        <div class="form__item">
            ...
            <input class="form__input" id="name" name="username" type="text" placeholder="Никнейм" required>
        </div>
        ...
        <div class="form__item">
            ...
            <input class="form__input" id="pass" name="pass" type="password" placeholder="Пароль" required>
        </div>
